"use client"
import { asyncForgotPasswordemploye, asyncSendMailemploye } from '@/store/actions/employeActions';
...
const page = () => {
    ...
    const changePasswordHandler = (e)=>{
        ...
        dispatch(asyncForgotPasswordemploye(newpassword));
        route.push("/employe/signin");
