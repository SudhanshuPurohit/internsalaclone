...
const page = () => {
    ...
    const forgotPasswordHandler = (e) => {
        ...
        console.log(employe);
        dispatch(asyncSendMailemploye(employe));
        route.push("/employe/forgot/sendmail");
    }
    ...
    return (
        ...
        <div className='container d-flex gap-3 flex-column mt-5 '>
            ...
            <form onSubmit={forgotPasswordHandler} className=' d-flex gap-3 flex-column'>
                ...
                {/* <Link onClick={forgotPasswordHandler} href="/employe/forgot/sendmail" className='btn btn-danger'>Send Mail</Link> */}
